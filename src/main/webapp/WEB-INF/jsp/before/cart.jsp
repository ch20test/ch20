				...
				<table width="99%" align="center" border="0" cellpadding="5"
					...
					<c:forEach var="ce" items="${cartlist}"> 
						<tr>
							...
							<td align="center" bgcolor="#ffffff" width="115px"
								valign="middle"><input type="text" name="goods_number" value="${ce.shoppingnum}" size="4"
								class="inputBg" style="text-align: center; width: 36px; color: #999999" /></td>
					...
					<tr>
						<td bgcolor="#ffffff" colspan="4" align="right"
							...
							<a href="before"> <img src="images/before/jxgw.jpg" alt="continue" /> </a>
						</td>
						
						<td bgcolor="#ffffff" align="center"
							style="border-left: 0 none; padding: 5px; padding-right: 2px;">
							<a style="cursor: pointer;" href="javascript:goOrderConfirm()"> <img src="images/before/qjs.jpg" alt="checkout" /> </a>
						</td>
					</tr>
